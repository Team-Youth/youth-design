...
import { TouchableOpacity, StyleSheet, ActivityIndicator, View, Text, TextInput as TextInput$1 } from 'react-native';
...
var TextInput = function (_a) {
  ...
  return jsxs(View, {
    style: style,
    children: [label && jsxs(Text, {
      style: getLabelStyle(),
      children: [label, required && jsx(Text, {
        style: {
          color: colors.semantic.state.error
        },
        children: " *"
...
export { Button, Icon, TextInput, borders, colors, coolGray, fontFamily, fontSize, fontWeight, gray, illustration, letterSpacing, lineHeight, primary, radius, semantic, shadows, spacing, textStyles, tint, tokens, typography };
