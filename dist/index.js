import { colors } from './chunk-DY2CS7O2.js';
export { colors, coolGray, gray, illustration, primary, semantic, tint } from './chunk-DY2CS7O2.js';
import { textStyles, fontWeight } from './chunk-2BHSI33V.js';
export { fontFamily, fontSize, fontWeight, letterSpacing, lineHeight, textStyles, typography } from './chunk-2BHSI33V.js';
import { spacing } from './chunk-DANMSRZE.js';
export { spacing } from './chunk-DANMSRZE.js';
import { radius } from './chunk-RJF4I7GM.js';
export { radius } from './chunk-RJF4I7GM.js';
import { shadows } from './chunk-LG5GZEXR.js';
export { shadows } from './chunk-LG5GZEXR.js';
import { border } from './chunk-SPOPCXZ5.js';
export { borders } from './chunk-SPOPCXZ5.js';
...
// src/tokens/index.ts
var tokens = {
  colors: () => import('./colors-3KX4UKV7.js'),
  typography: () => import('./typography-4QSATZCK.js'),
  spacing: () => import('./spacing-UNDTCQWF.js'),
  radius: () => import('./radius-KLNXE27B.js'),
  shadows: () => import('./shadows-J6WES5G3.js'),
  borders: () => import('./borders-BMM3JPFP.js')
};
  ...
  if (!svgContent) {
    ...
    return /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ jsx("circle", { cx: "12", cy: "12", r: "1", fill: color }) })
      }
    );
  }
...
var Illust = ({
  ...
  const illustStyle = __spreadValues({
    width: size,
    height: size,
    cursor: "inherit",
    transition: "all 0.2s ease",
  ...
  if (!svgContent) {
    ...
    return /* @__PURE__ */ jsx(
      "div",
      {
        ...
        tabIndex: onClick ? 0 : void 0,
        onKeyDown: handleKeyDown,
        children: /* @__PURE__ */ jsx("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ jsx("circle", { cx: "12", cy: "12", r: "1", fill: "currentColor" }) })
      }
    );
  }
...
var TextButton = ({
  ...
  const sizeConfig = {
    m: __spreadProps(__spreadValues({}, textStyles.body1), {
      fontWeight: fontWeight.medium,
      padding: "4px 8px"
    }),
    s: __spreadProps(__spreadValues({}, textStyles.body2), {
      fontWeight: fontWeight.medium,
      padding: "3px 6px"
    }),
    xs: __spreadProps(__spreadValues({}, textStyles.body3), {
      fontWeight: fontWeight.medium,
      padding: "2px 4px"
    })
  };
  ...
  const renderContent = () => {
    ...
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center" }, children: [
        children && /* @__PURE__ */ jsx("span", { children }),
        chevron && /* @__PURE__ */ jsx(Icon, { type: "arrow-right", size: 20, color: textColor })
      ] }),
      (icon == null ? void 0 : icon.right) && !chevron && icon.right
    ] });
  };
  return /* @__PURE__ */ jsx("button", { style: getStyles(), onClick: handleClick, disabled, className, children: renderContent() });
};
var Tab = ({
  type = "underline",
  size = "m",
  ...
  const getSizeConfig = () => {
    ...
    const configs = {
      l: __spreadProps(__spreadValues({}, type === "underline" ? textStyles.heading4 : type === "capsule" ? textStyles.heading4 : textStyles.body1), {
      ...
      m: __spreadProps(__spreadValues({}, type === "underline" ? textStyles.heading4 : type === "capsule" ? textStyles.heading4 : textStyles.body3), {
      ...
      s: __spreadProps(__spreadValues({}, type === "underline" ? textStyles.heading5 : type === "capsule" ? textStyles.body3 : textStyles.body2), {
  ...
  const getBaseStyles = () => __spreadValues({
  ...
  const renderIcon = () => {
    if (!icon) return null;
    return /* @__PURE__ */ jsx(Icon, { type: icon, size: config.iconSize, color: "currentColor" });
  };
  const renderNumber = () => {
...
var TabBar = ({
  ...
  return /* @__PURE__ */ jsx("div", { style: getContainerStyles(), className, children: tabs.map((tab, index) => /* @__PURE__ */ jsx(
    Tab,
...
var Radio = ({
  ...
  const getSizeConfig = () => {
    switch (size) {
      case "small":
        return __spreadProps(__spreadValues({}, textStyles.body3), {
          fontWeight: fontWeight.medium,
          radioSize: "16px",
          dotSize: "8px",
          gap: "4px",
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { style: radioContainerStyles, children: /* @__PURE__ */ jsx("div", { style: getRadioStyles(), children: /* @__PURE__ */ jsx("div", { style: getDotStyles() }) }) }),
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { style: getToggleStyles(), children: /* @__PURE__ */ jsx("div", { style: getThumbStyles() }) }),
        (label || description) && /* @__PURE__ */ jsxs("div", { style: labelContainerStyles, children: [
          label && /* @__PURE__ */ jsx("span", { style: getLabelStyles(), children: label }),
          description && /* @__PURE__ */ jsx("span", { style: getDescriptionStyles(), children: description })
        ] })
...
var CheckCircleIcon = ({ color }) => /* @__PURE__ */ jsxs("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", children: [
...
var CloseCircleIcon = ({ color }) => /* @__PURE__ */ jsxs("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", children: [
  /* @__PURE__ */ jsx("circle", { cx: "12", cy: "12", r: "11", fill: color }),
  /* @__PURE__ */ jsx(
    "path",
    {
...
var CautionIcon = ({ color }) => /* @__PURE__ */ jsxs("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", children: [
  /* @__PURE__ */ jsx("circle", { cx: "12", cy: "12", r: "11", fill: color }),
  /* @__PURE__ */ jsx("rect", { x: "11", y: "7", width: "2", height: "6", fill: "white", rx: "1" }),
  /* @__PURE__ */ jsx("circle", { cx: "12", cy: "16", r: "1", fill: "white" })
] });
var InfoIcon = ({ color }) => /* @__PURE__ */ jsxs("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", children: [
  /* @__PURE__ */ jsx("circle", { cx: "12", cy: "12", r: "11", fill: color }),
  /* @__PURE__ */ jsx("circle", { cx: "12", cy: "8", r: "1", fill: "white" }),
  /* @__PURE__ */ jsx("rect", { x: "11", y: "11", width: "2", height: "6", fill: "white", rx: "1" })
] });
var statusConfig = {
  success: {
...
var Toast = React11.memo(
  ({
    ...
    const titleStyle = __spreadProps(__spreadValues({}, textStyles.heading3), {
      color: colors.semantic.text.primary,
      margin: 0
    });
    const descriptionStyle = __spreadProps(__spreadValues({}, textStyles.body2), {
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        "aria-live": "polite",
        children: [
          showLeadingIcon && /* @__PURE__ */ jsx("div", { className: "toast__icon", children: /* @__PURE__ */ jsx(IconComponent, { color: config.color }) }),
          /* @__PURE__ */ jsxs("div", { className: "toast__content", style: contentStyle, children: [
            /* @__PURE__ */ jsx("h3", { className: "toast__title", style: titleStyle, children: title }),
            description && /* @__PURE__ */ jsx("p", { className: "toast__description", style: descriptionStyle, children: description })
          ] }),
          showCloseButton && onClose && /* @__PURE__ */ jsx(
            "button",
            {
              ...
              onMouseEnter: handleMouseEnter,
              onMouseLeave: handleMouseLeave,
              children: /* @__PURE__ */ jsx(Icon, { type: "close", size: 16, color: colors.semantic.text.tertiary })
            }
          )
        ]
      }
...
var useToast = () => {
  ...
  const remove = useCallback((id) => dismissToast(id), [dismissToast]);
...
var Modal = ({
  ...
  if (!isOpen) return null;
  const overlayStyleConfig = __spreadValues({
    position: "fixed",
    top: 0,
    left: 0,
    right: 0,
  ...
  const buttonContainerStyle = __spreadValues({
    display: "flex",
    gap: "12px",
    flexDirection: secondaryButton ? "row" : "column",
    flexShrink: 0
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "modal", style: modalStyle, children: [
        /* @__PURE__ */ jsxs("div", { className: "modal-content", style: contentStyle, children: [
          /* @__PURE__ */ jsxs("div", { className: "modal-header", style: headerStyle, children: [
            /* @__PURE__ */ jsx("h1", { style: titleStyle, children: title }),
            showCloseButton && /* @__PURE__ */ jsx("div", { style: closeButtonStyle, onClick: handleCloseClick, children: /* @__PURE__ */ jsx(Icon, { type: "close", size: 24, color: colors.semantic.text.secondary }) })
          ] }),
          description && /* @__PURE__ */ jsx("p", { style: descriptionStyle, children: description }),
          children && /* @__PURE__ */ jsx(
            "div",
        ...
        /* @__PURE__ */ jsxs("div", { className: "modal-buttons", style: buttonContainerStyle, children: [
          secondaryButton && /* @__PURE__ */ jsx(
            Button,
            __spreadProps(__spreadValues({
              type: "outlined",
...
var Dropdown = ({
  ...
  const getContainerStyles = useCallback(() => {
    let borderColor = colors.semantic.border.strong;
    let backgroundColor = colors.semantic.background.primary;
    if (disabled) {
  ...
  const getTextStyles = useCallback(() => {
    ...
    if (disabled) {
      ...
      textColor = colors.semantic.state.error;
  ...
  const getChevronIcon = useCallback(
    () => /* @__PURE__ */ jsx(Icon, { type: isOpen ? "chevron-up" : "chevron-down", size: 20, color: "currentColor" }),
    [isOpen]
  );
  ...
  const getOptionStyles = useCallback(
    (option, index, isSelected) => {
      let backgroundColor = colors.semantic.background.primary;
      let textColor = colors.semantic.text.primary;
      if (option.disabled) {
        textColor = colors.semantic.disabled.foreground;
      } else if (isSelected) {
  ...
  const dropdownOptionsStyle = useMemo(
    () => ({
      position: "absolute",
      top: "100%",
      left: 0,
  ...
  const getCheckIcon = () => /* @__PURE__ */ jsx(Icon, { type: "check", size: 20, color: "currentColor" });
  ...
  const renderLeadingIcon = () => {
    ...
    return /* @__PURE__ */ jsx(Icon, { type: leadingIconType, size: 20, color: getIconColor() });
  };
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              renderLeadingIcon(),
              isOpen && enableSearch ? /* @__PURE__ */ jsx(
                "input",
                {
                  ref: inputRef,
                  type: "text",
              ...
              ) : /* @__PURE__ */ jsx("div", { style: getTextStyles(), children: getDisplayText() }),
              /* @__PURE__ */ jsx(
                "div",
                {
                  style: {
        ...
        shouldRender && !hideOption && /* @__PURE__ */ jsx("div", { style: dropdownOptionsStyle, role: "listbox", ref: optionsContainerRef, children: filteredOptions.length === 0 ? /* @__PURE__ */ jsx(
          "div",
          {
            style: {
              padding: "13px 16px",
          ...
          return /* @__PURE__ */ jsxs(
            "div",
            {
              style: __spreadProps(__spreadValues({}, getOptionStyles(option, index, isSelected)), {
                userSelect: !enableSearch ? "none" : "auto"
                // 검색 기능이 비활성화된 경우 user-select none
              }),
...
var TextArea = forwardRef(
  (_a, ref) => {
    ...
    const getTextAreaStyles = () => {
      let textColor = colors.semantic.text.tertiary;
      if (disabled) {
        textColor = colors.semantic.text.tertiary;
      } else if (error) {
        textColor = colors.semantic.state.error;
      } else if (actualStatus === "filled") {
        textColor = colors.primary.coolGray[700];
      }
      return {
        width: "100%",
        minHeight: "160px",
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          (showCharacterCounter || error) && /* @__PURE__ */ jsxs(
            "div",
            {
              style: {
                display: "flex",
              ...
              children: [
                error && errorMessage && /* @__PURE__ */ jsxs(
                  "div",
                  {
                    style: {
                      display: "flex",
                    ...
                    children: [
                      /* @__PURE__ */ jsx(Icon, { type: "dialog", size: 16, color: colors.semantic.state.error }),
                      /* @__PURE__ */ jsx(
                        "span",
                        {
                          style: {
                ...
                showCharacterCounter && /* @__PURE__ */ jsxs(
                  "span",
                  {
                    style: {
                      fontSize: "14px",
...
var TextField = forwardRef(
  (_a, ref) => {
    ...
    const renderLeadingIcon = () => {
      if (leadingIconType) {
        return /* @__PURE__ */ jsx(Icon, { type: leadingIconType, size: 20, color: iconColor, onClick: onLeadingIconClick });
      }
      if (leadingIcon) {
        return /* @__PURE__ */ jsx(
          "div",
    ...
    const renderTrailingIcon = () => {
      if (trailingIconType) {
        return /* @__PURE__ */ jsx(Icon, { type: trailingIconType, size: 20, color: iconColor, onClick: onTrailingIconClick });
      }
      if (trailingIcon) {
        return /* @__PURE__ */ jsx(
          "div",
...
var Stepper = ({
  ...
  const stepperStyle = {
    ...
    padding: "12px 16px",
    borderRadius: "8px",
    border: `1px solid ${error ? colors.semantic.state.error : isFocused ? colors.primary.coolGray[800] : colors.primary.coolGray[300]}`,
  ...
  const inputStyle = __spreadProps(__spreadValues({}, textStyles.heading3), {
    background: "transparent",
    border: "none",
    outline: "none",
  ...
  return /* @__PURE__ */ jsxs("div", { className: `stepper ${className}`, style: containerStyle, children: [
    /* @__PURE__ */ jsxs("div", { style: stepperStyle, children: [
      /* @__PURE__ */ jsx(
        Icon,
        {
      ...
      /* @__PURE__ */ jsx("div", { style: valueContainerStyle, onClick: handleValueClick, children: isEditing ? /* @__PURE__ */ jsx(
        "input",
        {
          ref: inputRef,
          type: "text",
...
export { ActivityGoalCard_default as ActivityGoalCard, Button, Checkbox, Chips, Dropdown, ExerciseCard_default as ExerciseCard, ExerciseList_default as ExerciseList, Font, GreetingHeader_default as GreetingHeader, Icon, Illust, Label, Modal, Popup, Radio, Stepper, Tab, TabBar, Table, TextArea, TextButton, TextField, TextInput, Toast, ToastProvider, Toggle, YouthLottie, tokens, useToast };
