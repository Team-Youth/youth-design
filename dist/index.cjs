...
var chunkPCZNWLBQ_cjs = require('./chunk-PCZNWLBQ.cjs');
var chunkGXHDR5VG_cjs = require('./chunk-GXHDR5VG.cjs');
var chunk6OMK5ZOK_cjs = require('./chunk-6OMK5ZOK.cjs');
...
var Button = ({
  ...
  const getSolidStyles = (level2, disabled2, isLoading2, isPressed2, isHovered2) => {
    ...
    if (isLoading2) {
      if (level2 === "CTA") {
        return {
          ...
          color: chunkPCZNWLBQ_cjs.colors.semantic.background.primary,
          border: `1px solid ${chunkPCZNWLBQ_cjs.colors.primary.mainviolet}`
        };
      } else if (level2 === "secondary") {
        return {
          backgroundColor: chunkPCZNWLBQ_cjs.colors.primary.tint.violet[200],
          color: chunkPCZNWLBQ_cjs.colors.primary.mainviolet,
          border: `1px solid ${chunkPCZNWLBQ_cjs.colors.primary.tint.violet[200]}`
        };
    ...
    const levelColors = {
      CTA: {
        normal: { bg: chunkPCZNWLBQ_cjs.colors.primary.mainviolet, text: chunkPCZNWLBQ_cjs.colors.semantic.background.primary },
        hovered: { bg: chunkPCZNWLBQ_cjs.colors.primary.tint.violet[600], text: chunkPCZNWLBQ_cjs.colors.semantic.background.primary },
        pressed: { bg: chunkPCZNWLBQ_cjs.colors.primary.tint.violet[700], text: chunkPCZNWLBQ_cjs.colors.semantic.background.primary }
      },
      secondary: {
        normal: { bg: chunkPCZNWLBQ_cjs.colors.primary.tint.violet[100], text: chunkPCZNWLBQ_cjs.colors.primary.mainviolet },
        hovered: { bg: chunkPCZNWLBQ_cjs.colors.primary.tint.violet[200], text: chunkPCZNWLBQ_cjs.colors.primary.mainviolet },
        pressed: { bg: chunkPCZNWLBQ_cjs.colors.primary.tint.violet[300], text: chunkPCZNWLBQ_cjs.colors.primary.tint.violet[600] }
      },
      tertiary: {
        normal: { bg: chunkPCZNWLBQ_cjs.colors.semantic.disabled.background, text: chunkPCZNWLBQ_cjs.colors.semantic.text.primary },
        hovered: { bg: chunkPCZNWLBQ_cjs.colors.primary.coolGray[100], text: chunkPCZNWLBQ_cjs.colors.semantic.text.primary },
        pressed: { bg: chunkPCZNWLBQ_cjs.colors.semantic.disabled.foreground, text: chunkPCZNWLBQ_cjs.colors.semantic.text.primary }
      }
    };
  ...
  const getOutlinedStyles = (disabled2, isLoading2, isPressed2, isHovered2) => {
    if (disabled2) {
      return {
        ...
        color: chunkPCZNWLBQ_cjs.colors.semantic.disabled.foreground,
        border: `1px solid ${chunkPCZNWLBQ_cjs.colors.semantic.disabled.foreground}`
      };
    }
    if (isLoading2) {
      return {
        backgroundColor: chunkPCZNWLBQ_cjs.colors.semantic.background.primary,
        color: chunkPCZNWLBQ_cjs.colors.semantic.text.primary,
        border: `1px solid ${chunkPCZNWLBQ_cjs.colors.semantic.border.strong}`
      };
    }
    if (isPressed2) {
      return {
        backgroundColor: chunkPCZNWLBQ_cjs.colors.primary.coolGray[100],
        color: chunkPCZNWLBQ_cjs.colors.semantic.text.primary,
        border: `1px solid ${chunkPCZNWLBQ_cjs.colors.semantic.border.strong}`
      };
    } else if (isHovered2) {
...
var Icon = ({
  type,
  size = 24,
  color = chunkPCZNWLBQ_cjs.colors.primary.coolGray[800],
  onClick,
  className = "",
  style = {}
}) => {
...
var Label = ({
  ...
  const colorConfig = {
    grey: {
      backgroundColor: chunkPCZNWLBQ_cjs.colors.primary.coolGray[100],
      textColor: chunkPCZNWLBQ_cjs.colors.primary.coolGray[600],
      iconColor: chunkPCZNWLBQ_cjs.colors.primary.coolGray[700]
    },
    dark: {
      backgroundColor: chunkPCZNWLBQ_cjs.colors.primary.coolGray[600],
      textColor: chunkPCZNWLBQ_cjs.colors.primary.gray.white,
      iconColor: chunkPCZNWLBQ_cjs.colors.primary.gray.white
    },
    violet: {
      backgroundColor: chunkPCZNWLBQ_cjs.colors.primary.tint.violet[50],
      textColor: chunkPCZNWLBQ_cjs.colors.primary.tint.violet[500],
      iconColor: chunkPCZNWLBQ_cjs.colors.primary.tint.violet[500]
    },
    accent: {
      backgroundColor: chunkPCZNWLBQ_cjs.colors.primary.tint.violet[500],
      textColor: chunkPCZNWLBQ_cjs.colors.primary.gray.white,
      iconColor: chunkPCZNWLBQ_cjs.colors.primary.gray.white
    },
    red: {
      backgroundColor: chunkPCZNWLBQ_cjs.colors.primary.tint.red[500],
      textColor: chunkPCZNWLBQ_cjs.colors.primary.gray.white,
      iconColor: chunkPCZNWLBQ_cjs.colors.primary.gray.white
    },
    green: {
      backgroundColor: chunkPCZNWLBQ_cjs.colors.primary.tint.green[500],
      textColor: chunkPCZNWLBQ_cjs.colors.primary.gray.white,
      iconColor: chunkPCZNWLBQ_cjs.colors.primary.gray.white
    },
    yellow: {
      backgroundColor: chunkPCZNWLBQ_cjs.colors.primary.tint.yellow[500],
      textColor: chunkPCZNWLBQ_cjs.colors.primary.gray.white,
      iconColor: chunkPCZNWLBQ_cjs.colors.primary.gray.white
    }
  };
  ...
  (_a, ref) => {
    ...
    const sizeConfig = {
      ...
      s: chunkS367Y35J_cjs.__spreadProps(chunkS367Y35J_cjs.__spreadValues({
        ...
        borderRadius: "4px",
        height: "32px"
      }, chunkGXHDR5VG_cjs.textStyles.body3), {
        fontWeight: chunkGXHDR5VG_cjs.fontWeight.regular
      })
    };
    const getStyles = () => {
      ...
      let styles = {
        ...
        border: `${chunk42JHBZ7R_cjs.border.s} transparent`,
        outline: "none",
        transition: "all 0.2s ease",
        fontFamily: "inherit"
      };
      ...
      error && errorMessage && /* @__PURE__ */ jsxRuntime.jsx(
        "div",
        {
          style: {
            marginTop: "4px",
            fontSize: "12px",
            color: chunkPCZNWLBQ_cjs.colors.semantic.state.error,
            fontWeight: chunkGXHDR5VG_cjs.fontWeight.regular
          },
...
var TextButton = ({
  ...
  const getTextColor = () => {
    ...
    return color || chunkPCZNWLBQ_cjs.colors.primary.coolGray[800];
  };
  const getStyles = () => {
    const config = sizeConfig[size];
...
var Tab = ({
  ...
  const getSizeConfig = () => {
    const getFontWeight = () => {
      if (type === "toggle") {
        return selected ? chunkGXHDR5VG_cjs.fontWeight.semibold : chunkGXHDR5VG_cjs.fontWeight.medium;
      }
  ...
  const getColors = () => {
    if (disabled) {
      return {
        text: chunkPCZNWLBQ_cjs.colors.semantic.disabled.foreground,
        background: "transparent",
        border: "transparent",
        number: chunkPCZNWLBQ_cjs.colors.semantic.disabled.foreground
      };
    }
    switch (type) {
      case "underline":
        if (selected) {
          return {
            text: chunkPCZNWLBQ_cjs.colors.primary.coolGray[800],
            background: "transparent",
            border: chunkPCZNWLBQ_cjs.colors.primary.coolGray[800],
            number: chunkPCZNWLBQ_cjs.colors.primary.tint.violet[500]
          };
        }
        return {
          text: chunkPCZNWLBQ_cjs.colors.primary.coolGray[400],
          background: "transparent",
          border: "transparent",
          number: chunkPCZNWLBQ_cjs.colors.primary.coolGray[200]
        };
      case "capsule":
        if (selected) {
          return {
            text: chunkPCZNWLBQ_cjs.colors.primary.gray.white,
            background: chunkPCZNWLBQ_cjs.colors.primary.coolGray[800],
            border: "transparent",
            number: chunkPCZNWLBQ_cjs.colors.primary.tint.violet[500]
          };
        }
        return {
          text: chunkPCZNWLBQ_cjs.colors.primary.coolGray[800],
          background: "transparent",
          border: chunkPCZNWLBQ_cjs.colors.primary.coolGray[300],
          number: chunkPCZNWLBQ_cjs.colors.primary.coolGray[400]
        };
      case "toggle":
        if (selected) {
          return {
            text: chunkPCZNWLBQ_cjs.colors.primary.coolGray[800],
            background: chunkPCZNWLBQ_cjs.colors.primary.gray.white,
            border: "transparent",
            number: chunkPCZNWLBQ_cjs.colors.primary.tint.violet[500]
          };
        }
  ...
  const getHoverStyles = () => {
    ...
    switch (type) {
      case "underline":
        return {
          color: chunkPCZNWLBQ_cjs.colors.primary.coolGray[600],
          borderBottomColor: chunkPCZNWLBQ_cjs.colors.primary.coolGray[300]
        };
      case "capsule":
        return {
          backgroundColor: chunkPCZNWLBQ_cjs.colors.primary.coolGray[50],
          borderColor: chunkPCZNWLBQ_cjs.colors.primary.coolGray[400]
        };
      case "toggle":
        return {
          backgroundColor: chunkPCZNWLBQ_cjs.colors.primary.coolGray[100]
...
var TabBar = ({
  ...
  const getContainerStyles = () => {
    const baseStyles = {
      ...
      borderBottom: type === "underline" ? `1px solid ${chunkPCZNWLBQ_cjs.colors.semantic.border.default}` : "none",
      background: type === "toggle" ? chunkPCZNWLBQ_cjs.colors.primary.coolGray[50] : "transparent",
...
var Chips = ({
  ...
  const getTextColor = () => {
    switch (state) {
      case "selected":
        if (type === "square") {
          return chunkPCZNWLBQ_cjs.colors.primary.coolGray[800];
        }
        return chunkPCZNWLBQ_cjs.colors.primary.gray.white;
      case "disabled":
        return chunkPCZNWLBQ_cjs.colors.semantic.disabled.foreground;
      default:
        return chunkPCZNWLBQ_cjs.colors.primary.coolGray[800];
  ...
  const getIconColor = () => {
    ...
    switch (state) {
      case "selected":
        if (type === "square") {
          return chunkPCZNWLBQ_cjs.colors.primary.mainviolet;
        }
        return chunkPCZNWLBQ_cjs.colors.primary.gray.white;
      case "disabled":
        return chunkPCZNWLBQ_cjs.colors.semantic.disabled.foreground;
...
var Radio = ({
  ...
  const getRadioStyles = () => {
    if (disabled) {
      return {
        ...
        backgroundColor: !checked ? chunkPCZNWLBQ_cjs.colors.semantic.disabled.background : "transparent",
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
        cursor: "not-allowed",
      ...
      return {
        ...
        height: sizeConfig.radioSize,
        borderRadius: "50%",
        border: `2px solid ${chunkPCZNWLBQ_cjs.colors.semantic.border.strong}`,
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
        cursor: "pointer",
  ...
  const getDotStyles = () => {
    return {
      ...
      borderRadius: "50%",
      backgroundColor: checked ? disabled ? chunkPCZNWLBQ_cjs.colors.semantic.disabled.foreground : chunkPCZNWLBQ_cjs.colors.primary.mainviolet : "transparent",
      transition: "all 0.2s ease"
    };
  };
...
var Checkbox = ({
  ...
  const getIconColor = React10.useCallback(() => {
    if (disabled && checked) {
      ...
      return chunkPCZNWLBQ_cjs.colors.primary.coolGray[200];
    } else {
      return chunkPCZNWLBQ_cjs.colors.primary.coolGray[100];
    }
  }, [checked, disabled, isHovered]);
  const getLabelStyles = () => {
    return chunkS367Y35J_cjs.__spreadProps(chunkS367Y35J_cjs.__spreadValues({}, chunkGXHDR5VG_cjs.textStyles.body1), {
      fontWeight: chunkGXHDR5VG_cjs.fontWeight.medium,
      color: disabled ? chunkPCZNWLBQ_cjs.colors.semantic.disabled.foreground : chunkPCZNWLBQ_cjs.colors.primary.coolGray[800],
      cursor: disabled ? "not-allowed" : "pointer"
    });
  };
  const getDescriptionStyles = () => {
    return chunkS367Y35J_cjs.__spreadProps(chunkS367Y35J_cjs.__spreadValues({}, chunkGXHDR5VG_cjs.textStyles.body2), {
      fontWeight: chunkGXHDR5VG_cjs.fontWeight.regular,
      color: disabled ? chunkPCZNWLBQ_cjs.colors.semantic.disabled.foreground : chunkPCZNWLBQ_cjs.colors.primary.coolGray[300],
      lineHeight: "1.3",
      marginTop: "2px",
      cursor: disabled ? "not-allowed" : "pointer"
    });
  ...
  const getToggleStyles = () => {
    if (disabled) {
      ...
      return {
        ...
        height: sizeConfig.toggleHeight,
        borderRadius: sizeConfig.toggleHeight,
        backgroundColor: !checked ? chunkPCZNWLBQ_cjs.colors.primary.coolGray[200] : chunkPCZNWLBQ_cjs.colors.primary.tint.green[600],
        cursor: "pointer",
        transition: "all 0.3s ease",
        position: "relative",
        display: "flex",
...
var statusConfig = {
  success: {
    ...
    color: chunkPCZNWLBQ_cjs.colors.semantic.state.success
  },
  error: {
  ...
  warning: {
    icon: CautionIcon,
    color: chunkPCZNWLBQ_cjs.colors.semantic.state.warning
  },
  info: {
    icon: InfoIcon,
...
var Toast = React10__default.default.memo(
  ({
    ...
    const toastStyle = {
      display: "flex",
      alignItems: "center",
      gap: chunk6OMK5ZOK_cjs.spacing.m,
      padding: chunk6OMK5ZOK_cjs.spacing.l,
      backgroundColor: chunkPCZNWLBQ_cjs.colors.semantic.background.primary,
      borderRadius: chunkY5NEA52A_cjs.radius.l,
      boxShadow: chunkGC7ONM77_cjs.shadows.s,
      width: "360px",
      minHeight: "fit-content"
    };
    const contentStyle = {
    ...
    const closeButtonStyle = {
      ...
      border: "none",
      cursor: "pointer",
      padding: chunk6OMK5ZOK_cjs.spacing.xxs,
      display: "flex",
      alignItems: "center",
      justifyContent: "center",
        ...
        children: [
          ...
          showCloseButton && onClose && /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
              ...
              onMouseEnter: handleMouseEnter,
              onMouseLeave: handleMouseLeave,
              children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { type: "close", size: 16, color: chunkPCZNWLBQ_cjs.colors.semantic.text.tertiary })
            }
          )
        ]
      }
...
var Popup = ({
  ...
  const overlayStyle = chunkS367Y35J_cjs.__spreadValues({
    ...
    right: 0,
    bottom: 0,
    backgroundColor: chunkPCZNWLBQ_cjs.colors.semantic.dim.overlay,
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    zIndex: 1e3
...
var Modal = ({
  ...
  const modalStyle = chunkS367Y35J_cjs.__spreadValues({
    ...
    boxShadow: chunkGC7ONM77_cjs.shadows.m,
    display: "flex",
    flexDirection: "column",
  ...
  const buttonContainerStyle = chunkS367Y35J_cjs.__spreadValues({
    ...
    borderTop: `1px solid ${chunkPCZNWLBQ_cjs.colors.semantic.border.default}`,
    paddingTop: "20px",
    marginLeft: "-32px",
    marginRight: "-32px",
    paddingLeft: "32px",
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "modal", style: modalStyle, children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "modal-content", style: contentStyle, children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "modal-header", style: headerStyle, children: [
            /* @__PURE__ */ jsxRuntime.jsx("h1", { style: titleStyle, children: title }),
            showCloseButton && /* @__PURE__ */ jsxRuntime.jsx("div", { style: closeButtonStyle, onClick: handleCloseClick, children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { type: "close", size: 24, color: chunkPCZNWLBQ_cjs.colors.semantic.text.secondary }) })
          ] }),
          description && /* @__PURE__ */ jsxRuntime.jsx("p", { style: descriptionStyle, children: description }),
...
var Dropdown = ({
  ...
  const getContainerStyles = React10.useCallback(() => {
    ...
    if (disabled) {
      borderColor = chunkPCZNWLBQ_cjs.colors.semantic.border.strong;
      backgroundColor = chunkPCZNWLBQ_cjs.colors.semantic.disabled.background;
    } else if (error) {
      borderColor = chunkPCZNWLBQ_cjs.colors.semantic.state.error;
    } else if (isOpen) {
  ...
  const getTextStyles = React10.useCallback(() => {
    ...
    if (disabled) {
      ...
      textColor = chunkPCZNWLBQ_cjs.colors.semantic.state.error;
  ...
  const getIconColor = React10.useCallback(() => {
    if (disabled) {
      ...
      return chunkPCZNWLBQ_cjs.colors.semantic.state.error;
    } else {
        ...
        error && errorMessage && /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            style: {
              ...
              gap: chunk6OMK5ZOK_cjs.spacing.xxs,
              // 4px
              marginTop: chunk6OMK5ZOK_cjs.spacing.xxs
              // 4px
            },
            children: /* @__PURE__ */ jsxRuntime.jsx(
              "span",
  ...
  (_a, ref) => {
    ...
    const getContainerStyles = () => {
      ...
      return {
        ...
        width: getWidth(),
        border: `1px solid ${borderColor}`,
        borderRadius: chunkY5NEA52A_cjs.radius.s,
        // 8px
        backgroundColor,
        transition: "all 0.2s ease",
        position: "relative"
    ...
    const getTextAreaStyles = () => {
      ...
      if (disabled) {
        ...
        textColor = chunkPCZNWLBQ_cjs.colors.primary.coolGray[700];
      }
      return {
        width: "100%",
        minHeight: "160px",
        padding: `14px ${chunk6OMK5ZOK_cjs.spacing.m}`,
        // 14px 16px
        border: "none",
        outline: "none",
        backgroundColor: "transparent",
          ...
          (showCharacterCounter || error) && /* @__PURE__ */ jsxRuntime.jsxs(
            "div",
            {
              style: {
                ...
                marginTop: chunk6OMK5ZOK_cjs.spacing.xxs,
                // 4px
                gap: chunk6OMK5ZOK_cjs.spacing.s
                // 12px
              },
              children: [
                error && errorMessage && /* @__PURE__ */ jsxRuntime.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntime.jsx(Icon, { type: "dialog", size: 16, color: chunkPCZNWLBQ_cjs.colors.semantic.state.error }),
                      /* @__PURE__ */ jsxRuntime.jsx(
                        "span",
                        {
                          style: {
  ...
  (_a, ref) => {
    ...
    const getContainerStyles = React10.useCallback(() => {
      ...
      return {
        ...
        gap: chunk6OMK5ZOK_cjs.spacing.xs,
        // 8px
        padding: `13px ${chunk6OMK5ZOK_cjs.spacing.m}`,
        // 13px 16px
        backgroundColor,
        border: `1px solid ${borderColor}`,
        borderRadius: chunkY5NEA52A_cjs.radius.s,
          ...
          error && errorMessage && /* @__PURE__ */ jsxRuntime.jsxs(
            "div",
            {
              style: {
                ...
                gap: chunk6OMK5ZOK_cjs.spacing.xxs,
                // 4px
                marginTop: chunk6OMK5ZOK_cjs.spacing.xs
                // 8px
              },
              children: [
                /* @__PURE__ */ jsxRuntime.jsx(Icon, { type: "dialog", size: 16, color: chunkPCZNWLBQ_cjs.colors.semantic.state.error }),
...
var ExerciseCard = ({
  ...
  const typeConfig = {
    cardio: {
      ...
      bgColor: chunkPCZNWLBQ_cjs.colors.primary.tint.blue[50],
      icon: "\u{1F3C3}\u200D\u2642\uFE0F",
      label: "\uC720\uC0B0\uC18C"
    },
    strength: {
      color: chunkPCZNWLBQ_cjs.colors.primary.tint.red[500],
      bgColor: chunkPCZNWLBQ_cjs.colors.primary.tint.red[50],
      icon: "\u{1F4AA}",
      label: "\uADFC\uB825"
    },
    stretching: {
      color: chunkPCZNWLBQ_cjs.colors.primary.tint.green[500],
      bgColor: chunkPCZNWLBQ_cjs.colors.primary.tint.green[50],
      icon: "\u{1F9D8}\u200D\u2640\uFE0F",
      label: "\uC2A4\uD2B8\uB808\uCE6D"
    },
    balance: {
      color: chunkPCZNWLBQ_cjs.colors.primary.tint.violet[500],
      bgColor: chunkPCZNWLBQ_cjs.colors.primary.tint.violet[50],
      icon: "\u2696\uFE0F",
      label: "\uBC38\uB7F0\uC2A4"
    }
  };
  ...
  const cardStyles = {
    display: "flex",
    alignItems: "center",
    padding: chunk6OMK5ZOK_cjs.spacing.m,
    backgroundColor: isCompleted ? chunkPCZNWLBQ_cjs.colors.primary.coolGray[50] : chunkPCZNWLBQ_cjs.colors.semantic.background.primary,
    border: `1px solid ${isHovered ? currentTypeConfig.color : chunkPCZNWLBQ_cjs.colors.semantic.border.default}`,
    borderRadius: chunkY5NEA52A_cjs.radius.m,
    boxShadow: isHovered ? chunkGC7ONM77_cjs.shadows.m : chunkGC7ONM77_cjs.shadows.s,
    cursor: "pointer",
    transition: "all 0.3s ease",
    ...
    "div",
    {
      ...
      children: [
        isCompleted && /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            style: {
              ...
              width: "4px",
              height: "100%",
              backgroundColor: chunkPCZNWLBQ_cjs.colors.semantic.state.success
            }
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            style: {
              ...
              borderRadius: chunkY5NEA52A_cjs.radius.s,
              marginRight: chunk6OMK5ZOK_cjs.spacing.m,
              fontSize: "20px"
            },
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", marginBottom: chunk6OMK5ZOK_cjs.spacing.xxs }, children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              "h3",
              {
            ...
            /* @__PURE__ */ jsxRuntime.jsx(
              "span",
              {
                style: chunkS367Y35J_cjs.__spreadProps(chunkS367Y35J_cjs.__spreadValues({}, chunkGXHDR5VG_cjs.textStyles.caption), {
                  ...
                  borderRadius: chunkY5NEA52A_cjs.radius.xs,
                  marginLeft: chunk6OMK5ZOK_cjs.spacing.xs,
                  fontSize: "10px",
                  fontWeight: 500
                }),
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", gap: chunk6OMK5ZOK_cjs.spacing.m, alignItems: "center" }, children: [
            duration && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", gap: chunk6OMK5ZOK_cjs.spacing.xxs }, children: [
            ...
            calories && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", gap: chunk6OMK5ZOK_cjs.spacing.xxs }, children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", gap: chunk6OMK5ZOK_cjs.spacing.xs, alignItems: "center" }, children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
              ...
              style: {
                background: "none",
                border: `1px solid ${isCompleted ? chunkPCZNWLBQ_cjs.colors.semantic.state.success : chunkPCZNWLBQ_cjs.colors.semantic.border.default}`,
                cursor: "pointer",
                padding: chunk6OMK5ZOK_cjs.spacing.xs,
                borderRadius: chunkY5NEA52A_cjs.radius.xs,
                transition: "all 0.2s ease",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                backgroundColor: isCompleted ? chunkPCZNWLBQ_cjs.colors.semantic.state.success : "transparent"
              },
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx(
                "span",
                {
                  style: {
                    fontSize: "12px",
                    color: isCompleted ? chunkPCZNWLBQ_cjs.colors.semantic.background.primary : chunkPCZNWLBQ_cjs.colors.semantic.text.tertiary
                  },
...
var ActivityGoalCard = ({
  ...
  const themeConfig = {
    primary: {
      color: chunkPCZNWLBQ_cjs.colors.primary.mainviolet,
      bgColor: chunkPCZNWLBQ_cjs.colors.primary.tint.violet[50],
      lightColor: chunkPCZNWLBQ_cjs.colors.primary.tint.violet[100]
    },
    success: {
      color: chunkPCZNWLBQ_cjs.colors.semantic.state.success,
      bgColor: chunkPCZNWLBQ_cjs.colors.primary.tint.green[50],
      lightColor: chunkPCZNWLBQ_cjs.colors.primary.tint.green[100]
    },
    warning: {
      color: chunkPCZNWLBQ_cjs.colors.semantic.state.warning,
      bgColor: chunkPCZNWLBQ_cjs.colors.primary.tint.yellow[50],
      lightColor: chunkPCZNWLBQ_cjs.colors.primary.tint.yellow[100]
    },
    info: {
      color: chunkPCZNWLBQ_cjs.colors.semantic.state.info,
      bgColor: chunkPCZNWLBQ_cjs.colors.primary.tint.blue[50],
      lightColor: chunkPCZNWLBQ_cjs.colors.primary.tint.blue[100]
    }
  };
  ...
  const progressBarStyles = {
    width: "100%",
    height: "8px",
    backgroundColor: chunkPCZNWLBQ_cjs.colors.semantic.background.secondary,
    borderRadius: chunkY5NEA52A_cjs.radius.xs,
    overflow: "hidden",
    position: "relative"
  };
      ...
      children: [
        isCompleted && /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            style: {
              position: "absolute",
              top: chunk6OMK5ZOK_cjs.spacing.s,
              right: chunk6OMK5ZOK_cjs.spacing.s,
              fontSize: "20px",
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", marginBottom: chunk6OMK5ZOK_cjs.spacing.m }, children: [
          icon && /* @__PURE__ */ jsxRuntime.jsx(
            "div",
            {
              style: {
                ...
                color: chunkPCZNWLBQ_cjs.colors.semantic.background.primary,
                borderRadius: chunkY5NEA52A_cjs.radius.s,
                marginRight: chunk6OMK5ZOK_cjs.spacing.s,
                fontSize: "18px"
              },
              children: icon
            }
        ...
        /* @__PURE__ */ jsxRuntime.jsx("div", { style: { marginBottom: chunk6OMK5ZOK_cjs.spacing.s }, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline" }, children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "baseline", gap: chunk6OMK5ZOK_cjs.spacing.xxxs }, children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              "span",
              {
        ...
        /* @__PURE__ */ jsxRuntime.jsx("div", { style: progressBarStyles, children: /* @__PURE__ */ jsxRuntime.jsx("div", { style: progressFillStyles, children: /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            style: {
              ...
              borderRadius: `${chunkY5NEA52A_cjs.radius.xs} ${chunkY5NEA52A_cjs.radius.xs} 0 0`
            }
          }
        ) }) }),
...
var GreetingHeader = ({
  ...
  const getTimeBasedGreeting = () => {
    ...
    if (hour >= 5 && hour < 12) {
      return {
        ...
        textColor: chunkPCZNWLBQ_cjs.colors.primary.gray[800]
      };
      ...
      return {
        ...
        textColor: chunkPCZNWLBQ_cjs.colors.semantic.background.primary
      };
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `greeting-header ${className}`, style: headerStyles, onClick, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { position: "relative", zIndex: 1 }, children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", marginBottom: chunk6OMK5ZOK_cjs.spacing.s }, children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: "32px", marginRight: chunk6OMK5ZOK_cjs.spacing.s }, children: timeGreeting.emoji }),
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          style: {
            ...
            justifyContent: "space-between",
            alignItems: "center",
            marginTop: chunk6OMK5ZOK_cjs.spacing.m
          },
          children: [
            showDate && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", gap: chunk6OMK5ZOK_cjs.spacing.xs }, children: [
            ...
            weatherInfo && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", gap: chunk6OMK5ZOK_cjs.spacing.xs }, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        style: {
          position: "absolute",
          bottom: chunk6OMK5ZOK_cjs.spacing.s,
          right: chunk6OMK5ZOK_cjs.spacing.m,
          opacity: 0.7
        },
        children: /* @__PURE__ */ jsxRuntime.jsx(
          "span",
...
var ExerciseList = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `exercise-list ${className}`, children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { marginBottom: chunk6OMK5ZOK_cjs.spacing.l }, children: [
      /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          style: {
            ...
            justifyContent: "space-between",
            alignItems: "center",
            marginBottom: chunk6OMK5ZOK_cjs.spacing.m,
            padding: chunk6OMK5ZOK_cjs.spacing.m,
            backgroundColor: chunkPCZNWLBQ_cjs.colors.primary.coolGray[50],
            borderRadius: chunkY5NEA52A_cjs.radius.s,
            border: `1px solid ${chunkPCZNWLBQ_cjs.colors.semantic.border.default}`
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", gap: chunk6OMK5ZOK_cjs.spacing.s, alignItems: "center", fontSize: "12px" }, children: [
              stats.totalDuration > 0 && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { textAlign: "center", color: chunkPCZNWLBQ_cjs.colors.semantic.text.tertiary }, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
                "\u23F1\uFE0F ",
                stats.totalDuration,
                "\uBD84"
              ] }) }),
              stats.totalCalories > 0 && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { textAlign: "center", color: chunkPCZNWLBQ_cjs.colors.semantic.text.tertiary }, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
                "\u{1F525} ",
                stats.totalCalories,
                "kcal"
              ] }) })
      ...
      (showSearch || showFilters) && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { marginBottom: chunk6OMK5ZOK_cjs.spacing.m }, children: [
        showSearch && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { marginBottom: chunk6OMK5ZOK_cjs.spacing.s }, children: /* @__PURE__ */ jsxRuntime.jsx(
          "input",
          {
            type: "text",
            placeholder: "\uC6B4\uB3D9 \uAC80\uC0C9...",
            ...
            style: {
              width: "100%",
              padding: `${chunk6OMK5ZOK_cjs.spacing.s} ${chunk6OMK5ZOK_cjs.spacing.m}`,
              border: `1px solid ${chunkPCZNWLBQ_cjs.colors.semantic.border.default}`,
              borderRadius: chunkY5NEA52A_cjs.radius.s,
              fontSize: "14px",
              backgroundColor: chunkPCZNWLBQ_cjs.colors.semantic.background.primary,
            ...
            onFocus: (e) => {
              e.target.style.borderColor = chunkPCZNWLBQ_cjs.colors.primary.mainviolet;
            },
            onBlur: (e) => {
              e.target.style.borderColor = chunkPCZNWLBQ_cjs.colors.semantic.border.default;
            }
          }
        ) }),
        showFilters && /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            style: { display: "flex", gap: chunk6OMK5ZOK_cjs.spacing.s, flexWrap: "wrap", alignItems: "center" },
            children: [
              /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "flex", gap: chunk6OMK5ZOK_cjs.spacing.xxs }, children: filterOptions.map((option) => /* @__PURE__ */ jsxRuntime.jsxs(
                "button",
                {
                  onClick: () => setFilterType(option.value),
                  style: {
                    padding: `${chunk6OMK5ZOK_cjs.spacing.xs} ${chunk6OMK5ZOK_cjs.spacing.s}`,
                    border: `1px solid ${filterType === option.value ? chunkPCZNWLBQ_cjs.colors.primary.mainviolet : chunkPCZNWLBQ_cjs.colors.semantic.border.default}`,
                    borderRadius: chunkY5NEA52A_cjs.radius.xs,
                    backgroundColor: filterType === option.value ? chunkPCZNWLBQ_cjs.colors.primary.mainviolet : chunkPCZNWLBQ_cjs.colors.semantic.background.primary,
                    color: filterType === option.value ? chunkPCZNWLBQ_cjs.colors.semantic.background.primary : chunkPCZNWLBQ_cjs.colors.semantic.text.primary,
                    cursor: "pointer",
                    fontSize: "12px",
                    display: "flex",
                    alignItems: "center",
                    gap: chunk6OMK5ZOK_cjs.spacing.xxxs,
                    transition: "all 0.2s ease"
                  },
                  children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          style: {
            ...
            alignItems: "center",
            justifyContent: "center",
            padding: `${chunk6OMK5ZOK_cjs.spacing.xxxl} ${chunk6OMK5ZOK_cjs.spacing.l}`,
            textAlign: "center",
            color: chunkPCZNWLBQ_cjs.colors.semantic.text.tertiary
          },
          children: [
            /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontSize: "48px", marginBottom: chunk6OMK5ZOK_cjs.spacing.m }, children: emptyIcon }),
            /* @__PURE__ */ jsxRuntime.jsx(
              "h3",
              {
                style: chunkS367Y35J_cjs.__spreadProps(chunkS367Y35J_cjs.__spreadValues({}, chunkGXHDR5VG_cjs.textStyles.heading3), {
...
var Stepper = ({
  ...
  const stepperStyle = {
    ...
    padding: "12px 16px",
    borderRadius: "8px",
    border: `1px solid ${error ? chunkPCZNWLBQ_cjs.colors.semantic.state.error : isFocused ? chunkPCZNWLBQ_cjs.colors.primary.coolGray[800] : chunkPCZNWLBQ_cjs.colors.primary.coolGray[300]}`,
    backgroundColor: disabled ? chunkPCZNWLBQ_cjs.colors.primary.coolGray[50] : chunkPCZNWLBQ_cjs.colors.primary.gray.white,
    width: "100%",
    boxSizing: "border-box",
    transition: "all 0.2s ease",
    position: "relative",
  ...
  const inputStyle = chunkS367Y35J_cjs.__spreadProps(chunkS367Y35J_cjs.__spreadValues({}, chunkGXHDR5VG_cjs.textStyles.heading3), {
    ...
    border: "none",
    outline: "none",
    fontWeight: chunkGXHDR5VG_cjs.fontWeight.semibold,
    textAlign: "center",
    color: chunkPCZNWLBQ_cjs.colors.primary.coolGray[800],
    width: "100%",
    padding: 0,
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: stepperStyle, children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        Icon,
        {
          ...
          size: 24,
          color: disabled || isMinReached ? chunkPCZNWLBQ_cjs.colors.primary.coolGray[400] : chunkPCZNWLBQ_cjs.colors.primary.coolGray[800],
      ...
      /* @__PURE__ */ jsxRuntime.jsx("div", { style: valueContainerStyle, onClick: handleValueClick, children: isEditing ? /* @__PURE__ */ jsxRuntime.jsx(
        ...
        Font,
        {
          type: "heading3",
          fontWeight: "semibold",
          color: disabled ? chunkPCZNWLBQ_cjs.colors.primary.coolGray[400] : error ? chunkPCZNWLBQ_cjs.colors.semantic.state.error : chunkPCZNWLBQ_cjs.colors.primary.coolGray[800],
          align: "center",
          style: {
            userSelect: "none"
          },
      ...
      /* @__PURE__ */ jsxRuntime.jsx(
        Icon,
        {
          ...
          size: 24,
          color: disabled || isMaxReached ? chunkPCZNWLBQ_cjs.colors.primary.coolGray[400] : chunkPCZNWLBQ_cjs.colors.primary.coolGray[800],
...
Object.defineProperty(exports, "colors", {
  enumerable: true,
  get: function () { return chunkPCZNWLBQ_cjs.colors; }
});
Object.defineProperty(exports, "coolGray", {
  enumerable: true,
  get: function () { return chunkPCZNWLBQ_cjs.coolGray; }
});
Object.defineProperty(exports, "gray", {
  enumerable: true,
  get: function () { return chunkPCZNWLBQ_cjs.gray; }
});
Object.defineProperty(exports, "illustration", {
  enumerable: true,
  get: function () { return chunkPCZNWLBQ_cjs.illustration; }
});
Object.defineProperty(exports, "primary", {
  enumerable: true,
  get: function () { return chunkPCZNWLBQ_cjs.primary; }
});
Object.defineProperty(exports, "semantic", {
  enumerable: true,
  get: function () { return chunkPCZNWLBQ_cjs.semantic; }
});
Object.defineProperty(exports, "tint", {
  enumerable: true,
  get: function () { return chunkPCZNWLBQ_cjs.tint; }
});
Object.defineProperty(exports, "fontFamily", {
  enumerable: true,
  get: function () { return chunkGXHDR5VG_cjs.fontFamily; }
});
Object.defineProperty(exports, "fontSize", {
  enumerable: true,
  get: function () { return chunkGXHDR5VG_cjs.fontSize; }
});
Object.defineProperty(exports, "fontWeight", {
  enumerable: true,
  get: function () { return chunkGXHDR5VG_cjs.fontWeight; }
});
Object.defineProperty(exports, "letterSpacing", {
  enumerable: true,
  get: function () { return chunkGXHDR5VG_cjs.letterSpacing; }
});
Object.defineProperty(exports, "lineHeight", {
  enumerable: true,
  get: function () { return chunkGXHDR5VG_cjs.lineHeight; }
});
Object.defineProperty(exports, "textStyles", {
  enumerable: true,
  get: function () { return chunkGXHDR5VG_cjs.textStyles; }
});
Object.defineProperty(exports, "typography", {
  enumerable: true,
  get: function () { return chunkGXHDR5VG_cjs.typography; }
});
Object.defineProperty(exports, "spacing", {
  enumerable: true,
  get: function () { return chunk6OMK5ZOK_cjs.spacing; }
});
Object.defineProperty(exports, "radius", {
  enumerable: true,
  get: function () { return chunkY5NEA52A_cjs.radius; }
});
Object.defineProperty(exports, "shadows", {
  enumerable: true,
  get: function () { return chunkGC7ONM77_cjs.shadows; }
});
Object.defineProperty(exports, "borders", {
  enumerable: true,
  get: function () { return chunk42JHBZ7R_cjs.borders; }
});
