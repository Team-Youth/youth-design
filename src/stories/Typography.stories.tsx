...
export const MedicalContent: Story = {
  render: () => (
    <div style={{ maxWidth: '600px' }}>
      <div style={typography.textStyles.display1}>
        청년 건강 플랫폼
      </div>
      
      <div style={{ marginTop: '24px' }}>
        <div style={typography.textStyles.heading2}>
          진료 예약 안내
        </div>
        <div style={{ 
          ...
          온라인으로 간편하게 진료를 예약하고, 전문의와 상담받으세요. 
          24시간 언제든지 예약이 가능하며, 예약 확인은 문자메시지로 발송됩니다.
        </div>
      </div>

      <div style={{ marginTop: '32px', padding: '20px', backgroundColor: '#F8F4FE', borderRadius: '12px' }}>
        <div style={typography.textStyles.heading3}>
          이용 안내
        </div>
        
        <div style={{ marginTop: '16px' }}>
          <div style={typography.textStyles.heading5}>
            진료 시간
          </div>
          <div style={{ 
